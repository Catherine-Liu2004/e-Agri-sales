package com.eagrilift.framework.web.domain;

import java.net.UnknownHostException;
import java.util.LinkedList;
import java.util.List;
import java.util.Properties;
import com.eagrilift.common.utils.Arith;
import com.eagrilift.common.utils.ip.IpUtils;
import com.eagrilift.framework.web.domain.server.Cpu;
import com.eagrilift.framework.web.domain.server.Jvm;
import com.eagrilift.framework.web.domain.server.Mem;
import com.eagrilift.framework.web.domain.server.Sys;
import com.eagrilift.framework.web.domain.server.SysFile;
